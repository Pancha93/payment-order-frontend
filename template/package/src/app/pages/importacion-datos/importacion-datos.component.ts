...
/** Flags de estado */
  ...
  private initializeEntityAttributes(): void {
    this.entityAttributesMap.set('Ordenpago', [
      { name: 'numeroOrden', type: 'String', required: true },
      { name: 'estado', type: 'String', required: true },
      { name: 'facturaUrl', type: 'String', required: true },
      { name: 'facturaImagen', type: 'String', required: true },
      { name: 'fechaCreacion', type: 'LocalDate', required: true },
      { name: 'fechaDecision', type: 'LocalDate', required: true },
