...
import { LeerOrdenpagoComponent } from './leer-ordenpago.component';
import { OrdenpagoService } from '../../../services/OrdenpagoService';

/**
 * Suite de pruebas para el componente LeerOrdenpago
 */
describe('LeerOrdenpagoComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerOrdenpagoComponent;
  let fixture: ComponentFixture<LeerOrdenpagoComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ LeerOrdenpagoComponent ],
      imports: [ 
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerOrdenpagoComponent);
