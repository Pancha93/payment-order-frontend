...
export class ReporteComponent implements OnInit {
  ...
  private initializeServices(): void {
    // Servicio dinámico para Ordenpago
    import('../../services/OrdenpagoService')
      .then(module => {
        const serviceInstance = new module.OrdenpagoService(this.httpClient);
        this.entityServicesMap.set('Ordenpago', serviceInstance);
      })
      .catch(error => console.error('Error loading service for Ordenpago:', error));
  ...
  private initializeEntityAttributes(): void {
    // Atributos para la entidad Ordenpago
    this.entityAttributesMap.set('Ordenpago', [
      { name: 'id', type: 'long', selected: false },
      { name: 'numeroOrden', type: 'String', selected: false },
      { name: 'estado', type: 'String', selected: false },
      { name: 'facturaUrl', type: 'String', selected: false },
      { name: 'facturaImagen', type: 'String', selected: false },
      { name: 'fechaCreacion', type: 'LocalDate', selected: false },
      { name: 'fechaDecision', type: 'LocalDate', selected: false },
